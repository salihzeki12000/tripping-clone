...
export const getImageRequest = (payload) => dispatch => {
  ...
  console.log(payload)
    axios.get("http://trippingbackend.gunjan.tech/entity/images/" + payload)
        .then(res => res.data)
...
export const getDataRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("http://trippingbackend.gunjan.tech/entity/basic_detail/" + payload)
        .then(res => res.data)
...
export const getReviewRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("http://trippingbackend.gunjan.tech/entity/review/" + payload)
        .then(res => res.data)
...
export const getRecommendRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("http://trippingbackend.gunjan.tech/entity/recommendation/" + payload)
        .then(res => res.data)
