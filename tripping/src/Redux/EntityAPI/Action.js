...
export const getImageRequest = (payload) => dispatch => {
  ...
  console.log(payload)
    axios.get("https://42dc6de86567.ngrok.io/entity/images/" + payload)
        .then(res => res.data)
...
export const getDataRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("https://42dc6de86567.ngrok.io/entity/basic_detail/" + payload)
        .then(res => res.data)
...
export const getReviewRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("https://42dc6de86567.ngrok.io/entity/review/" + payload)
        .then(res => res.data)
...
export const getRecommendRequest = (payload) => dispatch => {
    // console.log('getDataFromAPI')
    console.log(payload)
    axios.get("https://42dc6de86567.ngrok.io/entity/recommendation/" + payload)
        .then(res => res.data)
