...
Revision ID: 9cae7040080a
Revises: 
Create Date: 2020-07-25 00:05:26.697454
...
def upgrade():
    ...
    sa.Column('no_smoking', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['room_id'], ['room_details.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('room_details', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['room_details'], ['room_details.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('room_details')
    )
